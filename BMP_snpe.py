...
#     bmp_prior = distrax.Independent(log_uniform)
...
class Workspace:
    def __init__(self, cfg):
        ...
        self.subdir = os.path.join(os.getcwd(), "neurips_bmp_final", 'BMP', file_name, str(cfg.designs.num_xi), str(cfg.seed), current_time_str)
    ...
    def _init_logging(self):
        ...
        logf = open(path, 'a') 
        fieldnames = ['STEP', 'Xi', 'Loss', 'EIG', 'inference_time', 'simulate_time']
...
from BMP_snpe import Workspace as W
