...
priors, prior_log_prob = prior.sample_and_log_prob(
    seed=next(prng_seq), sample_shape=(num_samples,)
)
...
def single_sample_log_ratio(y_sample, d_star, theta0_i, theta1_i, theta0_s, theta1_s):
    ...
    log_probs_matrix = kde_log_probs_d_star_theta_s(
        y_sample, d_star, theta0_s, theta1_s
    )
