...
class ConditionalBlock(Block):
    ...
    def forward(self, x: Array, theta: Array, xi: Array) -> Array:
        ...
        return self._bijector.forward(x, theta, xi)
    ...
    def forward_and_log_det(
        ...
        self._check_forward_input_shape(x)
        y, log_det = self._bijector.forward_and_log_det(x, theta, xi)
    ...
    def inverse_and_log_det(
        ...
        self._check_inverse_input_shape(y)
        x, log_det = self._bijector.inverse_and_log_det(y, theta, xi)
